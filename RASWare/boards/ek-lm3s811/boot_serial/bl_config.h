...
//*****************************************************************************
//
// The USB vendor ID published by the DFU device.  This value is the Luminary
// Micro vendor ID.  Change this to the vendor ID you have been assigned by
// USB-IF.
//
...
// non-update operation.  If you have sublicensed Luminary Micro's vendor ID,
// you must use an assigned product ID here.
//
// Depends on: USB_ENABLE_UPDATE
// Exclusive of: None
// Requires: None
