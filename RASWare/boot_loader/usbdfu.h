...
//*****************************************************************************
//
// Luminary-specific request identifier.  This is used to determine whether
...
// sending back a tDFUQueryLuminaryProtocol structure indicating that Luminary
...
//
// wValue        - 0x23(REQUEST_LUMINARY_VALUE)
// wIndex        - Interface number
// wLength       - sizeof(tDFUQueryLuminaryProtocol)
//
//*****************************************************************************
#define USBD_DFU_REQUEST_LUMINARY    0x42

#define REQUEST_LUMINARY_VALUE 0x23
...
//*****************************************************************************
//
// The structure sent to the host when a valid USBD_DFU_REQUEST_LUMINARY is
...
PACKED tDFUQueryLuminaryProtocol;
...
// read via USBD_DFU_REQUEST_UPLOAD following Luminary-specific commands such
// as DFU_CMD_INFO.
//
//*****************************************************************************
typedef struct
